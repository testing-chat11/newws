...
[Rocket.Chat](https://arma.chat) is an open-source fully customizable communications platform developed in JavaScript for organizations with high standards of data protection.
...
Every day, tens of millions of users in over 150 countries and in organizations such as Deutsche Bahn, The US Navy, and Credit Suisse trust [Rocket.Chat](https://arma.chat) to keep their communications completely private and secure.
...
Please refer to [Install Rocket.Chat](https://arma.chat/install) to install your Rocket.Chat instance.
...
- [See who's using Rocket.Chat](https://arma.chat/customer-stories)

## Become a Rocketeer

We're hiring developers, support people, and product managers all the time. Please check our [jobs page](https://arma.chat/jobs).

## Get the Latest News

- [Twitter](https://twitter.com/RocketChat)
- [Blog](https://arma.chat/blog)
- [Facebook](https://www.facebook.com/RocketChatApp)
- [LinkedIn](https://www.linkedin.com/company/rocket-chat)
- [Youtube](https://www.youtube.com/channel/UCin9nv7mUjoqrRiwrzS5UVQ)
- [Email Newsletter](https://arma.chat/newsletter)

Any other questions, reach out to us at [our website](https://arma.chat/contact) or you can email us directly at [contact@rocket.chat](mailto:contact@rocket.chat). We’d be happy to help!
# newws
